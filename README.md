# dotnet-10-jwt-refresh-tokens

.NET 10.0 - JWT Authentication with Refresh Tokens Tutorial with Example API
...
- [`The Vue 3 Client at GitHub`](https://github.com/persteenolsen/vue-jwt-refresh-auth-client) - The Vue 3 Client using JWT + Refresh Tokens for Auth
...
- A .NET 10 Web API
- A Vue 3 Web Client for the Frontend
- Entity Framework
